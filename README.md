...
local/texlive-langchinese 2022.62922-1 (texlive-lang)
...
本魔改适用于 texlive 2020，使用 `xelatex->bibtex->xelatex->xelatex` 编译链。在 macOS, Windows 10, Arch Linux (kernel 6.1.2) 下进行修改与测试，无法完全保证其它平台的正常使用。
...
* 移除 CJK，使用 ctex
* 根据现行本科生毕业论文规范修改格式
* 适应 macOS, Windows, Arch Linux 与 xelatex
* 为适应我推荐的工具链做了一些优化
...
* 修订了 `./Thesis/clean.sh` 脚本，使其能够适应类 Unix 系统下的清理工作
